        ...
        <x-form id="save-email-template-form">
            ...
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    @lang('modules.emailMarketing.addEmail')</h4>
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
                ...
                <x-form-actions>
                    <x-forms.button-primary id="save-email-template" class="mr-3" icon="check">@lang('app.save')
                    </x-forms.button-primary>
                    <x-forms.button-secondary class="mr-3" id="save-more-email-template" icon="check-double">@lang('app.saveAddMore')
...
<script>
    $(document).ready(function () {
        ...
        $('#save-more-email-template').click(function () {
            ...
            const url = "{{ route('email-marketing.store') }}";
            var data = $('#save-email-template-form').serialize();

            saveEmailTemplate(data, url, "#save-more-email-template");
        ...
        $('#save-email-template').click(function() {
            ...
            saveEmailTemplate(data, url, "#save-email-template");
