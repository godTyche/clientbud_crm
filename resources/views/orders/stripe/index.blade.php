<div class="modal-header">
    ...
    <div class="modal-body">
        <div class="portlet-body">
            <x-form id="stripeAddress" method="POST" class="ajax-form" action="{{ route('stripe', [$orderID]) }}">
                <div class="form-body">
...
<script>
    ...
    $('#save-stripe-detail').click( function () {
        ...
        let url = "{{ route('orders.save_stripe_detail') }}";
        ...
        $.easyAjax({
            ...
            type: 'POST',
            url: url,
            data: $('#stripeAddress').serialize()+'&order_id='+order_id,
