...
<!-- NAV ITEM - EMAIL MARKETING -->
@if (in_array('admin', user_roles()) || in_array('emailmarketing', user_modules()) && $sidebarUserPermissions['view_emailmarketing'] != 5 && $sidebarUserPermissions['view_emailmarketing'] != 'none')
        <x-menu-item icon="email" :text="__('app.menu.emailMarketing')" :link="route('email-marketing.index')">
            <x-slot name="iconPath">
                <path 
...
@if (in_array('admin', user_roles()) || in_array('emailmarketing', user_modules()) && $sidebarUserPermissions['view_resourcecenter'] != 5 && $sidebarUserPermissions['view_resourcecenter'] != 'none')
