            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <?php if(!config('laravel_google_translate.google_translate_api_key')): ?>
                        <p>
                            <code>
                            Enable Cloud Translation API from Google Cloud Console and create API key. Enter the API on <a href="<?php echo route('language-settings.index') ?>" target="">Settings >> Language Settings >> Auto Translate Setting</a>.
                            </code>
                        </p>
                    <?php endif; ?>
                    <div class="form-group">
